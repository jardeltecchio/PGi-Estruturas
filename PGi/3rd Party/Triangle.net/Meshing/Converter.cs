...
namespace TriangleNet.Meshing
{
    ...
    public class Converter
    {
        ...
        /// </summary>
        public Mesh ToMesh(Polygon_TriangleNET polygon, ICollection<ITriangle> triangles)
        {
        ...
        /// Reconstruct a triangulation from its raw data representation.
        /// </summary>
        public Mesh ToMesh(Polygon_TriangleNET polygon, ITriangle[] triangles, Configuration config = null)
        {
        ...
        /// </summary>
        private void SetSegments(Mesh mesh, Polygon_TriangleNET polygon, List<Otri>[] vertexarray)
        {
            Otri checktri = default(Otri);
