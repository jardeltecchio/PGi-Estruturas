...
namespace TriangleNet.Geometry
{
    ...
    /// </summary>
    public class Polygon_TriangleNET : IPolygon //mudei para Polygon_TriangleNET p ñ ficar ambiguo com a classe polygon do .net ..jardel
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="Polygon_TriangleNET" /> class.
        /// </summary>
        public Polygon_TriangleNET()
            : this(3, false)
        {
        }
        ...
        public Polygon_TriangleNET(int capacity)
            : this(capacity, false)
        {
        }
        ...
        public Polygon_TriangleNET(int capacity, bool markers)
        {
