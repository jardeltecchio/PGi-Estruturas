...
namespace TriangleNet.IO
{
    ...
    public class TriangleReader
    {
        ...
        /// </summary>
        public void Read(string filename, out Polygon_TriangleNET polygon)
        {
        ...
        /// </summary>
        public void Read(string filename, out Polygon_TriangleNET geometry, out List<ITriangle> triangles)
        {
            triangles = null;
        ...
        {
            Read(filename, out Polygon_TriangleNET geometry);
        ...
        public Polygon_TriangleNET ReadNodeFile(string nodefilename)
        {
        ...
        public Polygon_TriangleNET ReadNodeFile(string nodefilename, bool readElements)
        {
            Polygon_TriangleNET data;
            ...
            using (var reader = new StreamReader(nodefilename))
            {
                ...
                data = new Polygon_TriangleNET(invertices);
        ...
        /// <remarks>Will NOT read associated .ele by default.</remarks>
        public Polygon_TriangleNET ReadPolyFile(string polyfilename)
        {
        ...
        public Polygon_TriangleNET ReadPolyFile(string polyfilename, bool readElements)
        {
        ...
        public Polygon_TriangleNET ReadPolyFile(string polyfilename, bool readElements, bool readArea)
        {
            // Read poly file
            Polygon_TriangleNET data;
