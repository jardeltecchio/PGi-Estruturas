...
//		}
		...
		private void InitializeComponent()
		{
            ...
            this._panel.Font = new System.Drawing.Font("Arial", 3F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Pixel, ((byte)(0)));
            this._panel.ForeColor = System.Drawing.Color.LavenderBlush;
            this._panel.Location = new System.Drawing.Point(0, 0);
            this._panel.Margin = new System.Windows.Forms.Padding(1);
		...
		private void ToolBarDockHolder_Paint(object sender, System.Windows.Forms.PaintEventArgs e)
		{
			if(DockStyle == DockStyle.None) 
			{
				...
				// Added by mav
                Rectangle rec = new Rectangle(0, 0, this.Width - 16, 14);

                DrawString(e.Graphics, ToolbarTitle, rec , SystemBrushes.ControlText);
               
                //criar o botao de fechar quando o holder for maior que 60, pois ocorria de, se a janela tivesse 
                // só um botao e fosse muito pequena,o holder fechar quando arrastava ele para
                // fora, pois o mouse ficava bem em cima do botão  ao arrastar, e ao soltar o botao do mouse, a janela fechava
				...
				r.Width--;
				r.Height--;
                e.Graphics.DrawRectangle(new Pen(SystemColors.Window), r);
			}
			else
			{
				...
				if(DockStyle != DockStyle.Right && DockStyle != DockStyle.Left) 
				{
					for(int i=1; i<this.Size.Height-1; i+=off) 
					e.Graphics.DrawLine(pen, new Point(off, i), new Point(off+off-1, i));
                        e.Graphics.DrawLine(pen, new Point(off, this.Height-4), new Point(off,2));
                       // e.Graphics.DrawLine(pen, new Point(1, this.Height-4), new Point(2, this.Height-1));
                } 
				else 
				{
					for(int i=1; i<this.Size.Width-1; i+=off) 
						e.Graphics.DrawLine(pen, new Point(i, off), new Point(i, off+off-1));
                    e.Graphics.DrawLine(pen, new Point(3, 7), new Point(this.Width-2, 7));
                 //    e.Graphics.DrawLine(pen, new Point(this.Width - 2, 6), new Point(this.Width - 2, 7));
                }
			}
		}
		...
		private void ToolBarDockHolder_MouseUp(object sender, System.Windows.Forms.MouseEventArgs e)
		{
			...
			if((e.Button == MouseButtons.Left 
				...
				&& e.Y < 16 && e.X > Width-16) &&  (ClientRectangle.Width > 60))
			{
				FloatForm.Visible = false;
			}
		}
